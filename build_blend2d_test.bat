...
cl %COMMON% /std:c++20 /EHsc %INCLUDES% /Febuild\test_blend2d_live_blit.exe tests_src\test_blend2d_live_blit.cpp build\blend2d_unity.obj build\sizetable.obj build\checksum_sse4_2.obj build\otglyf_sse4_2.obj build\pixelconverter_ssse3.obj user32.lib advapi32.lib shell32.lib gdi32.lib /Fobuild\
if %ERRORLEVEL% NEQ 0 exit /b %ERRORLEVEL%

build\test_blend2d_live_blit.exe
